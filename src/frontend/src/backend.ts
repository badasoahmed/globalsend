...
export class Backend implements backendInterface {
    ...
    async addRecipient(arg0: Recipient): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addRecipient(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getRecipients(): Promise<Array<Recipient>> {
        if (this.processError) {
            try {
                const result = await this.actor.getRecipients();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getTransferHistory(): Promise<Array<Transfer>> {
        if (this.processError) {
            try {
    ...
    async transferMoney(arg0: Recipient, arg1: number, arg2: string, arg3: string): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.transferMoney(arg0, arg1, arg2, arg3);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
